...
import common.classes.semanticmodels.lts.assertion.AssertionDeterminism;
import module.tcj.lts.*;

import java.util.ArrayList;
import java.util.List;

public class TCJAssertionDeterminism extends AssertionDeterminism {
    private DefinitionRef Process;
    private Valuation GlobalEnv;

    public TCJAssertionDeterminism(DefinitionRef processDef) {
        Process = processDef;
    }
